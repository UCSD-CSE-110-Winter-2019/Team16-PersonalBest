...
public class AddFriendsUITestSuccess {
    ...
    @Test
    public void addFriendsUITestSuccess() {
        ...
        onView(withText("You've sent ivivchar@ucsd.edu\na friend request!")).inRoot(withDecorView(not(is(mActivityTestRule.getActivity().getWindow().getDecorView())))).check(matches(isDisplayed()));
    }
}
